namespace NBAManagement.Models
{
    ...
    public partial class Season
    {
        ...
        public static Season LastSeason
        {
            get
            {
                if (lastSeason == null)
                {
                    lastSeason = NBAContext.Instance.Season.ToList().Last();
                }
                return lastSeason;
            }
        }
        public static Season[] TestSeason { get; } = NBAContext.Instance.Season.ToArray();
